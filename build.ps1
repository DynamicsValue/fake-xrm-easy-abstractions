...
if($IsLinux) {
    ./packages/xunit.runner.console/2.4.1/tools/net462/xunit.console.exe ./tests/FakeXrmEasy.Abstractions.Tests/bin/$configuration/**/FakeXrmEasy.Abstractions.Tests.dll
}
else {
    if($targetFrameworks -eq "all")
    {
